...
namespace RxMed.Migrations
{
    ...
    [Migration("20230613123548_Updated_Table_relation")]
    partial class Updated_Table_relation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RxMed.Models.User", b =>
                {
                    ...
                    b.Property<int>("default_address_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RxMed.Models.User", b =>
                {
                    b.HasOne("RxMed.Models.Address", "DefaultAddress")
                        .WithMany()
                        .HasForeignKey("default_address_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
